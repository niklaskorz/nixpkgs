...
stdenv.mkDerivation {
  ...
  patches = [
    ...
    (fetchpatch {
      url = "https://raw.githubusercontent.com/livekit/rust-sdks/10f358017b2d01fb4f53c84ebadff088049a7a3f/webrtc-sys/libwebrtc/patches/add_licenses.patch";
      hash = "sha256-9A4KyRW1K3eoQxsTbPX0vOnj66TCs2Fxjpsu5wO8mGI=";
    })
    # Fixes the certificate chain, required for Let's Encrypt certs
    (fetchpatch {
      url = "https://raw.githubusercontent.com/livekit/rust-sdks/10f358017b2d01fb4f53c84ebadff088049a7a3f/webrtc-sys/libwebrtc/patches/ssl_verify_callback_with_native_handle.patch";
      hash = "sha256-RBvRcJzoKItpEbqpe07YZe1D1ZVGS12EnDSISldGy+0=";
    })
    # Adds dependencies and features required by livekit
    (fetchpatch {
      url = "https://raw.githubusercontent.com/livekit/rust-sdks/10f358017b2d01fb4f53c84ebadff088049a7a3f/webrtc-sys/libwebrtc/patches/add_deps.patch";
      hash = "sha256-DwRtGdU5sppmiFsVuyhJoVCQrRl5JFmZJfxgUPhYXBg=";
    })
  ]
  ++ lib.optionals stdenv.cc.isGNU [
    # Required for full GCC compatibility
    (fetchpatch {
      url = "https://raw.githubusercontent.com/livekit/rust-sdks/10f358017b2d01fb4f53c84ebadff088049a7a3f/webrtc-sys/libwebrtc/patches/force_gcc.patch";
      hash = "sha256-J3V9OS05HmKGswn2n5KuQF8WQ7CuVGQtItGVCYDHOv8=";
      stripLen = 1;
      extraPrefix = "build/";
    })
  ];
  ...
  postPatch = ''
    ...
    substituteInPlace BUILD.gn \
      ...
      --replace-fail 'cflags = []' 'cflags = [ "-fvisibility=default" ]' \
      --replace-fail 'ldflags = []' 'ldflags = [ "-lavutil", "-lavformat", "-lavcodec" ]'
